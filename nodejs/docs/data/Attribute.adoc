...
[#_Attribute_getHas_transaction_TypeDBTransaction_annotations_Annotation]
==== getHas
...
[#_Attribute_getHas_transaction_TypeDBTransaction_attributeTypes_AttributeType]
==== getHas
...
[#_Attribute_getHas_transaction_TypeDBTransaction_attributeTypes_AttributeType_annotations_Annotation]
==== getHas
...
[#_Attribute_getRelations_transaction_TypeDBTransaction_roleTypes_RoleType]
==== getRelations
