...
[#_Entity_getHas_transaction_TypeDBTransaction_annotations_Annotation]
==== getHas
...
[#_Entity_getHas_transaction_TypeDBTransaction_attributeTypes_AttributeType]
==== getHas
...
[#_Entity_getHas_transaction_TypeDBTransaction_attributeTypes_AttributeType_annotations_Annotation]
==== getHas
...
[#_Entity_getRelations_transaction_TypeDBTransaction_roleTypes_RoleType]
==== getRelations
