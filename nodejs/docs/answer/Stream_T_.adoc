...
[#_Stream_T_every_callbackFn_value_unknown]
==== every
...
[#_Stream_T_filter_filter_value_boolean]
==== filter
...
[#_Stream_T_flatMap_mapper_value_Stream_U]
==== flatMap
...
[#_Stream_T_forEach_fn_value_void]
==== forEach
...
[#_Stream_T_some_callbackFn_value_unknown]
==== some
