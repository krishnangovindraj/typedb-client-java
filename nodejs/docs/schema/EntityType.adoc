...
[#_EntityType_getOwns_transaction_TypeDBTransaction_annotations_Annotation]
==== getOwns
...
[#_EntityType_getOwns_transaction_TypeDBTransaction_valueType_ValueType_annotations_Annotation]
==== getOwns
...
[#_EntityType_setOwns_transaction_TypeDBTransaction_attributeType_AttributeType_annotations_Annotation]
==== setOwns
...
[#_EntityType_setOwns_transaction_TypeDBTransaction_attributeType_AttributeType_overriddenType_AttributeType_annotations_Annotation]
==== setOwns
