...
[#_RelationType_getOwns_transaction_TypeDBTransaction_annotations_Annotation]
==== getOwns
...
[#_RelationType_getOwns_transaction_TypeDBTransaction_valueType_ValueType_annotations_Annotation]
==== getOwns
...
[#_RelationType_setOwns_transaction_TypeDBTransaction_attributeType_AttributeType_annotations_Annotation]
==== setOwns
...
[#_RelationType_setOwns_transaction_TypeDBTransaction_attributeType_AttributeType_overriddenType_AttributeType_annotations_Annotation]
==== setOwns
