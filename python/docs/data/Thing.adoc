...
[#_Thing_get_has_transaction_TypeDBTransaction_attribute_type_AttributeType_attribute_types_list_AttributeType_annotations_set_Annotation]
==== get_has
...
[#_Thing_get_relations_transaction_TypeDBTransaction_role_types_list_RoleType]
==== get_relations
