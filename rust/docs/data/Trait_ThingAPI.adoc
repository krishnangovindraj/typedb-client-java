...
// tag::methods[]
[#_trait_ThingAPI_delete_transaction_tx_Transaction]
==== delete
...
[#_trait_ThingAPI_get_has_transaction_tx_Transaction_attribute_type_attribute_types_Vec_AttributeType_annotations_Vec_Annotation]
==== get_has
...
[#_trait_ThingAPI_get_playing_transaction_tx_Transaction]
==== get_playing
...
[#_trait_ThingAPI_get_relations_transaction_tx_Transaction_role_types_Vec_RoleType]
==== get_relations
...
[#_trait_ThingAPI_is_deleted_transaction_tx_Transaction]
==== is_deleted
