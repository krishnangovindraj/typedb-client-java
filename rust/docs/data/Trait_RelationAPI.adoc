...
[#_trait_RelationAPI_get_players_by_role_type_transaction_tx_Transaction_role_types_Vec_RoleType]
...
[#_trait_RelationAPI_get_relating_transaction_tx_Transaction]
==== get_relating
