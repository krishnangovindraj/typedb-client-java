...
[#_struct_QueryManager_get_aggregate]
==== get_aggregate
...
[#_struct_QueryManager_get_group]
==== get_group
...
[#_struct_QueryManager_get_group_aggregate]
==== get_group_aggregate
