...
// tag::methods[]
[#_trait_RelationTypeAPI_create_transaction_tx_Transaction]
==== create
...
[#_trait_RelationTypeAPI_get_supertype_transaction_tx_Transaction]
==== get_supertype
...
[#_trait_RelationTypeAPI_get_supertypes_transaction_tx_Transaction]
==== get_supertypes
...
[#_trait_RelationTypeAPI_set_relates_transaction_tx_Transaction_role_label_String_overridden_role_label_Option_String]
==== set_relates
