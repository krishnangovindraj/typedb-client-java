...
// tag::methods[]
[#_trait_RoleTypeAPI_delete_transaction_tx_Transaction]
==== delete
...
[#_trait_RoleTypeAPI_get_relation_type_transaction_tx_Transaction]
==== get_relation_type
...
[#_trait_RoleTypeAPI_get_relation_types_transaction_tx_Transaction]
==== get_relation_types
...
[#_trait_RoleTypeAPI_get_supertype_transaction_tx_Transaction]
==== get_supertype
...
[#_trait_RoleTypeAPI_get_supertypes_transaction_tx_Transaction]
==== get_supertypes
...
[#_trait_RoleTypeAPI_is_abstract]
==== is_abstract
...
[#_trait_RoleTypeAPI_is_deleted_transaction_tx_Transaction]
==== is_deleted
