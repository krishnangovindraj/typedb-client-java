...
[#_struct_Options_read_any_replica]
==== read_any_replica
...
[#_struct_Options_schema_lock_acquire_timeout]
...
[#_struct_Options_session_idle_timeout]
...
[#_struct_Options_trace_inference]
==== trace_inference
...
[#_struct_Options_transaction_timeout]
==== transaction_timeout
