...
[#_struct_UserManager_contains_username_impl_Into_String]
==== contains
...
[#_struct_UserManager_create_username_impl_Into_String_password_impl_Into_String]
==== create
...
[#_struct_UserManager_current_user]
==== current_user
...
[#_struct_UserManager_delete_username_impl_Into_String]
==== delete
...
[#_struct_UserManager_get_username_impl_Into_String]
==== get
...
[#_struct_UserManager_set_password_username_impl_Into_String_password_impl_Into_String]
==== set_password
