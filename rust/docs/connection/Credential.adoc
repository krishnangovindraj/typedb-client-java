...
// tag::methods[]
[#_struct_Credential_is_tls_enabled]
==== is_tls_enabled
...
[#_struct_Credential_with_tls_username_str_password_str_tls_root_ca_Option_Path]
==== with_tls
