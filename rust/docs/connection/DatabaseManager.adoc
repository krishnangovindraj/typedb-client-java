...
[#_struct_DatabaseManager_contains_name_impl_Into_String]
==== contains
...
[#_struct_DatabaseManager_create_name_impl_Into_String]
==== create
...
[#_struct_DatabaseManager_get_name_impl_Into_String]
==== get
