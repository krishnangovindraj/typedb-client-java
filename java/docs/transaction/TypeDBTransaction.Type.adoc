...
[#_TypeDBTransaction_Type_isRead]
==== isRead
...
[#_TypeDBTransaction_Type_isWrite]
==== isWrite
...
[#_TypeDBTransaction_Type_of_com_vaticle_typedb_driver_jni_TransactionType]
==== of
...
[#_TypeDBTransaction_Type_values]
==== values
