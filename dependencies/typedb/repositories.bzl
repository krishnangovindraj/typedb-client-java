...
def typedb_dependencies():
    git_repository(
        ...
        remote = "https://github.com/krishnangovindraj/typedb-dependencies",
        commit = "a4d6c475fa070dbb0715bd070648c288e262a4dc",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typedb_dependencies
    )
