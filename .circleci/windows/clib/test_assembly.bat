...
cmake ..\c\tests\assembly -DTYPEDB_ASSEMBLY=%cd%\typedb-driver-clib-windows-x86_64 
cmake --build . --config release
popd
set PATH=%cd%\test_assembly_clib\typedb-driver-clib-windows-x86_64\lib;%PATH%;

START /B "" typedb-server-windows\typedb server --diagnostics.reporting.statistics=false
